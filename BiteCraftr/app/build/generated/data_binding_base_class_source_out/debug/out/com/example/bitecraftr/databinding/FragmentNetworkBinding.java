...
public final class FragmentNetworkBinding implements ViewBinding {
  ...
  @NonNull
  public final LottieAnimationView lottieAnimationViewNetwork;
  ...
  public static FragmentNetworkBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.lottieAnimationViewNetwork;
      LottieAnimationView lottieAnimationViewNetwork = ViewBindings.findChildViewById(rootView, id);
      if (lottieAnimationViewNetwork == null) {
        break missingId;
      }
