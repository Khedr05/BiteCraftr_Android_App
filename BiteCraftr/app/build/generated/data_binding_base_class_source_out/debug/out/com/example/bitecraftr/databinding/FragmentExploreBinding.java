...
public final class FragmentExploreBinding implements ViewBinding {
  ...
  private FragmentExploreBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView2) {
  ...
  public static FragmentExploreBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentExploreBinding((ConstraintLayout) rootView, textView2);
    }
